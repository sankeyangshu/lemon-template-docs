      ...
      '/mobile-react/': [
        {
          ...
          items: [
            ...
            { text: '网络请求', link: '/mobile-react/request' },
            { text: '图标', link: '/mobile-react/icons' },
            { text: '国际化', link: '/mobile-react/locale' },
            { text: '状态管理', link: '/mobile-react/store' },
            { text: 'Echarts 图表', link: '/mobile-react/echarts' },
          ],
        },
      ],
      '/mobile-vue/': [
        {
          ...
          items: [
            ...
            // { text: '国际化', link: '/mobile-vue/locale' },
